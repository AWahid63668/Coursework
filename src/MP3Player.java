...
public class MP3Player
{
    ...
    private final String ROOT_DIR = "U:/CoputerScience/Coursework/src/sample/Songs/";
    ...
    {
        final Media media = new Media(new File(ROOT_DIR + song.getTitle().replace(" ", "_") + ".mp3").toURI().toString());
    ...
    public void loadAllSongs()
    {
        pause();
        queue.clear();
        for (Song song : dbConn.allSongs()) queue.add(mediaPlayerFromSong(song));
    }
